 ...
 */
public class ExpandingListView2 extends ListView {
    ...
    public ExpandingListView2(Context context) {
        super(context);
        init();
    }

    public ExpandingListView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ExpandingListView2(Context context, AttributeSet attrs, int defStyle) {
    ...
    private AdapterView.OnItemClickListener mItemClickListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick (AdapterView<?> parent, View view, int position, long id) {
            MenuData viewObject = (MenuData)getItemAtPosition(getPositionForView(view));
    ...
    private void expandView(final View view) {
        final MenuData viewObject = (MenuData)getItemAtPosition(getPositionForView
                (view));
        ...
        final View expandingLayout = view.findViewById(R.id.expanding_layout2);
        ...
        observer.addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
            ...
            public boolean onPreDraw() {
                ...
                *  must also be added to a list of views which will be drawn in dispatchDraw.*/
                ...
                animations.add(ObjectAnimator.ofFloat(view.findViewById(R.id.expanding_layout2),
                        View.ALPHA, 0, 1));
     ...
     */
     ...
     private void collapseView(final View view) {
        final MenuData viewObject = (MenuData)getItemAtPosition
