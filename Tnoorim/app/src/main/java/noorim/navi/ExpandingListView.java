...
public class ExpandingListView extends ListView {
    ...
    private AdapterView.OnItemClickListener mItemClickListener = new AdapterView
        ...
        public void onItemClick (AdapterView<?> parent, View view, int position, long id) {
            EventData viewObject = (EventData)getItemAtPosition(getPositionForView(view));
    ...
    private void expandView(final View view) {
        final EventData viewObject = (EventData)getItemAtPosition(getPositionForView
                (view));
     ...
     */
     ...
     private void collapseView(final View view) {
        final EventData viewObject = (EventData)getItemAtPosition
